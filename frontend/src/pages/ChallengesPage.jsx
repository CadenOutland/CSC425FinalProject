  ...
  const handleSaveChallenge = async (challengeToSave) => {
    try {
      ...
      const payload = {
        ...
        description:
          challengeToSave.description || challengeToSave.instructions || '',
  ...
  return (
    <div className="challenges-page">
      <div className="page-header">
        ...
        <p>
          Browse saved challenges. To generate new ones, use AI Challenge
          Generator.
        </p>
      </div>
      ...
      {activeTab === 'ai-generator' && <AIChallengeGenerator />}
